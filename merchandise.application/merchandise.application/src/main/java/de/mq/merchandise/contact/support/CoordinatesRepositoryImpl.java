...
class CoordinatesRepositoryImpl implements CoordinatesRepository {
	...
	final Collection<?> mapping;
	 ...
	 final MapBasedResponseClassFactory mapBasedResponseClassFactory;
	...
	public final Coordinates forAddress(final CityAddress cityAddress) {
        ...
        final MapBasedResponse response = restOperations.getForObject(GOOGLE_URL,mapBasedResponseClassFactory.createClass( mapping), params);
