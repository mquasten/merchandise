...
public interface DocumentController {
	...
	@MethodInvocation(actions={@ActionEvent(params={ @Parameter(clazz = DocumentModelAO.class , el="#arg.returnFromUpload" , elResultType=String.class)}, endConversation=true)}, clazz = DocumentControllerImpl.class)
	String cancelUpLoad();
