...
public class AddressbookUI extends AbstractUIBeanInjector {
	...
	private void initContactList() {
		...
		contactList.setVisibleColumns(new Object[] { FNAME, LNAME, "Street" , "City", "Distance" });
	...
	private  IndexedContainer createDummyDatasource() {
		...
		Object referenceId = ic.addItem();
	
		ic.getContainerProperty(referenceId, FNAME).setValue("Eigene Adresse");
		ic.getContainerProperty(referenceId, LNAME).setValue("Home-Location");
		ic.getContainerProperty(referenceId, "Street").setValue("Bahnhofstraße 123");
		ic.getContainerProperty(referenceId, "City").setValue("Wegberg");
		ic.getContainerProperty(referenceId, "Zip").setValue("41844");
		ic.getContainerProperty(referenceId, "Country").setValue("DE");
		ic.getContainerProperty(referenceId, "State").setValue("NRW");
