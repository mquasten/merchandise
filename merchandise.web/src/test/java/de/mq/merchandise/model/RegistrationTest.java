...
public class RegistrationTest {
	...
	public final void personMap() {
		...
		final RegistrationImpl registration= new RegistrationImpl(legalPersonAO, naturalPersonAO,user, customer, null);
	...
	public final void customerDomain() {
		...
		final RegistrationImpl registration= new RegistrationImpl(Mockito.mock(LegalPersonAO.class), Mockito.mock(NaturalPersonAO.class),Mockito.mock(User.class), customerAO, null);
	...
	public final void kind() {
		final RegistrationImpl registration= new RegistrationImpl(Mockito.mock(LegalPersonAO.class), Mockito.mock(NaturalPersonAO.class),Mockito.mock(User.class), Mockito.mock(CustomerAO.class), null);
